...
class MineSweeper:
    ...
    def __init__(self):
        ...
        flagged = tk.Label(self.window, text=f'🚩 {MineSweeper.FLAG} ', font='Verdana 24 bold')
        flagged.grid(row=0, column=MineSweeper.COLUMNS//2, columnspan=2, padx=10, pady=10)
    ...
    def click(self, clicked_button: MyButton):
        ...
        if MineSweeper.OPEN_CELLS == MineSweeper.ROW * MineSweeper.COLUMNS - MineSweeper.MINES:
    ...
    def restart(self):
        ...
        MineSweeper.FLAG = MineSweeper.MINES
        MineSweeper.OPEN_CELLS = 0
